...
def run() -> None:
    ...
    navigation = st.navigation(
        [
            ...
            st.Page("pages/04_feature_selection.py", title="PREPARACIÓN Y FEATURE SELECTION", icon=":material/filter_alt:"),
            ...
            st.Page("pages/08_prediccion.py", title="PREDICCIÓN INTERACTIVA", icon=":material/query_stats:"),
